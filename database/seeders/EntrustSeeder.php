...
class EntrustSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $manageMain = Permission::create(['name' => 'main', 'display_name' => ['ar' =>  'الرئيسية', 'en'   =>  'Main'], 'route' => 'index', 'module' => 'index', 'as' => 'index', 'icon' => 'fas fa-home', 'parent' => '0', 'parent_original' => '0', 'sidebar_link' => '1', 'appear' => '1', 'ordering' => '1']);
        $manageMain->parent_show = $manageMain->id;
        $manageMain->save();


        //manage Document categories
        $manageDocumentCategories = Permission::create(['name' => 'manage_document_categories', 'display_name' => ['ar'    =>  'إدارة تصنيف الوثائق',   'en'    =>  'Manage Document Categories'], 'route' => 'document_categories', 'module' => 'document_categories', 'as' => 'document_categories.index', 'icon' => 'fas fa-file-contract', 'parent' => '0', 'parent_original' => '0', 'sidebar_link' => '1', 'appear' => '1', 'ordering' => '5',]);
        $manageDocumentCategories->parent_show = $manageDocumentCategories->id;
        $manageDocumentCategories->save();
        $showDocumentCategories    =  Permission::create(['name' => 'show_document_categories', 'display_name'       =>    ['ar'   =>  'تصنيف الوثائق',   'en'    =>  ' Categories'],   'route' => 'document_categories', 'module' => 'document_categories', 'as' => 'document_categories.index', 'icon' => 'fas fa-file-contract', 'parent' => '0', 'parent_original' => '0', 'parent_show' => '0', 'sidebar_link' => '0', 'appear' => '0']);
        $createDocumentCategories  =  Permission::create(['name' => 'create_document_categories', 'display_name'     =>    ['ar'   =>  'إضافة تصنيف الوثيقة',   'en'    =>  'Add Document Category'],    'route' => 'document_categories', 'module' => 'document_categories', 'as' => 'document_categories.create', 'icon' => null, 'parent' => '0', 'parent_original' => '0', 'parent_show' => '0', 'sidebar_link' => '0', 'appear' => '0']);
        $displayDocumentCategories =  Permission::create(['name' => 'display_document_categories', 'display_name'    =>    ['ar'   =>  ' عرض تصنيف الوثيقة',   'en'    =>  'Display Document Category'],    'route' => 'document_categories', 'module' => 'document_categories', 'as' => 'document_categories.show', 'icon' => null, 'parent' => '0', 'parent_original' => '0', 'parent_show' => '0', 'sidebar_link' => '0', 'appear' => '0']);
        $updateDocumentCategories  =  Permission::create(['name' => 'update_document_categories', 'display_name'     =>    ['ar'   =>  'تعديل تصنيف الوثيقة',   'en'    =>  'Edit Document Category'],    'route' => 'document_categories', 'module' => 'document_categories', 'as' => 'document_categories.edit', 'icon' => null, 'parent' => '0', 'parent_original' => '0', 'parent_show' => '0', 'sidebar_link' => '0', 'appear' => '0']);
        $deleteDocumentCategories  =  Permission::create(['name' => 'delete_document_categories', 'display_name'     =>    ['ar'   =>  'حذف تصنيف الوثيقة',   'en'    =>  'Delete Document Category'],    'route' => 'document_categories', 'module' => 'document_categories', 'as' => 'document_categories.destroy', 'icon' => null, 'parent' => '0', 'parent_original' => '0', 'parent_show' => '0', 'sidebar_link' => '0', 'appear' => '0']);


        //manage Document Types
        $manageDocumentTypes = Permission::create(['name' => 'manage_document_types', 'display_name' => ['ar'    =>  ' إدارة انواع الوثائق',   'en'    =>  '’Manage Document Types'], 'route' => 'document_types', 'module' => 'document_types', 'as' => 'document_types.index', 'icon' => 'fas fa-file-signature', 'parent' => '0', 'parent_original' => '0', 'sidebar_link' => '1', 'appear' => '1', 'ordering' => '10',]);
        $manageDocumentTypes->parent_show = $manageDocumentTypes->id;
        $manageDocumentTypes->save();
        $showDocumentTypes    =  Permission::create(['name' => 'show_document_types', 'display_name'       =>    ['ar'   =>  'انواع الوثائق',   'en'    =>  ' Document Types'],   'route' => 'document_types', 'module' => 'document_types', 'as' => 'document_types.index', 'icon' => 'fas fa-file-signature', 'parent' => '0', 'parent_original' => '0', 'parent_show' => '0', 'sidebar_link' => '0', 'appear' => '0']);
        $createDocumentTypes  =  Permission::create(['name' => 'create_document_types', 'display_name'     =>    ['ar'   =>  'إضافة نوع وثيقة',   'en'    =>  'Add Document Type'],    'route' => 'document_types', 'module' => 'document_types', 'as' => 'document_types.create', 'icon' => null, 'parent' => '0', 'parent_original' => '0', 'parent_show' => '0', 'sidebar_link' => '0', 'appear' => '0']);
        $displayDocumentTypes =  Permission::create(['name' => 'display_document_types', 'display_name'    =>    ['ar'   =>  ' عرض نوع وثيقة',   'en'    =>  'Display Document Type'],    'route' => 'document_types', 'module' => 'document_types', 'as' => 'document_types.show', 'icon' => null, 'parent' => '0', 'parent_original' => '0', 'parent_show' => '0', 'sidebar_link' => '0', 'appear' => '0']);
        $updateDocumentTypes  =  Permission::create(['name' => 'update_document_types', 'display_name'     =>    ['ar'   =>  'تعديل نوع وثيقة',   'en'    =>  'Edit Document Type'],    'route' => 'document_types', 'module' => 'document_types', 'as' => 'document_types.edit', 'icon' => null, 'parent' => '0', 'parent_original' => '0', 'parent_show' => '0', 'sidebar_link' => '0', 'appear' => '0']);
        $deleteDocumentTypes  =  Permission::create(['name' => 'delete_document_types', 'display_name'     =>    ['ar'   =>  'حذف نوع وثيقة',   'en'    =>  'Delete Document Type'],    'route' => 'document_types', 'module' => 'document_types', 'as' => 'document_types.destroy', 'icon' => null, 'parent' => '0', 'parent_original' => '0', 'parent_show' => '0', 'sidebar_link' => '0', 'appear' => '0']);


        //manage Document Templates
        $manageDocumentTemplates = Permission::create(['name' => 'manage_document_templates', 'display_name' => ['ar'    =>  ' إدارة نموذج المستند',   'en'    =>  '’Manage Document Templates'], 'route' => 'document_templates', 'module' => 'document_templates', 'as' => 'document_templates.index', 'icon' => 'fas fa-file-signature', 'parent' => '0', 'parent_original' => '0', 'sidebar_link' => '1', 'appear' => '1', 'ordering' => '15',]);
        $manageDocumentTemplates->parent_show = $manageDocumentTemplates->id;
        $manageDocumentTemplates->save();
        $showDocumentTemplates    =  Permission::create(['name' => 'show_document_templates', 'display_name'       =>    ['ar'   =>  'نموذج المستند',   'en'    =>  ' Document Templates'],   'route' => 'document_templates', 'module' => 'document_templates', 'as' => 'document_templates.index', 'icon' => 'fas fa-file-signature', 'parent' => '0', 'parent_original' => '0', 'parent_show' => '0', 'sidebar_link' => '0', 'appear' => '0']);
        $createDocumentTemplates  =  Permission::create(['name' => 'create_document_templates', 'display_name'     =>    ['ar'   =>  'إضافة نموذج مستند جديد',   'en'    =>  'Add Document Template'],    'route' => 'document_templates', 'module' => 'document_templates', 'as' => 'document_templates.create', 'icon' => null, 'parent' => '0', 'parent_original' => '0', 'parent_show' => '0', 'sidebar_link' => '0', 'appear' => '0']);
        $displayDocumentTemplates =  Permission::create(['name' => 'display_document_templates', 'display_name'    =>    ['ar'   =>  ' عرض نموذج مستند',   'en'    =>  'Display Document Template'],    'route' => 'document_templates', 'module' => 'document_templates', 'as' => 'document_templates.show', 'icon' => null, 'parent' => '0', 'parent_original' => '0', 'parent_show' => '0', 'sidebar_link' => '0', 'appear' => '0']);
        $updateDocumentTemplates  =  Permission::create(['name' => 'update_document_templates', 'display_name'     =>    ['ar'   =>  'تعديل نموذج مستند',   'en'    =>  'Edit Document Template'],    'route' => 'document_templates', 'module' => 'document_templates', 'as' => 'document_templates.edit', 'icon' => null, 'parent' => '0', 'parent_original' => '0', 'parent_show' => '0', 'sidebar_link' => '0', 'appear' => '0']);
        $deleteDocumentTemplates  =  Permission::create(['name' => 'delete_document_templates', 'display_name'     =>    ['ar'   =>  'حذف نموذج',   'en'    =>  'Delete Document Template'],    'route' => 'document_templates', 'module' => 'document_templates', 'as' => 'document_templates.destroy', 'icon' => null, 'parent' => '0', 'parent_original' => '0', 'parent_show' => '0', 'sidebar_link' => '0', 'appear' => '0']);

        //manage Document Templates
        $manageDocuments = Permission::create(['name' => 'manage_documents', 'display_name' => ['ar'    =>  ' إدارة الوثائق',   'en'    =>  '’Manage Documents'], 'route' => 'documents', 'module' => 'documents', 'as' => 'documents.index', 'icon' => 'fas fa-file-signature', 'parent' => '0', 'parent_original' => '0', 'sidebar_link' => '1', 'appear' => '1', 'ordering' => '20',]);
        ...
        //manage Document Datas
        $manageDocumentDatas = Permission::create(['name' => 'manage_document_datas', 'display_name' => ['ar'    =>  ' إدارة بيانات الوثيقة',   'en'    =>  '’Manage Document Datas'], 'route' => 'document_datas', 'module' => 'document_datas', 'as' => 'document_datas.index', 'icon' => 'fas fa-file-signature', 'parent' => '0', 'parent_original' => '0', 'sidebar_link' => '1', 'appear' => '1', 'ordering' => '25',]);
        ...
        $manageDocumentArchives = Permission::create(['name' => 'manage_document_archives', 'display_name' => ['ar'    =>  ' إدارة إرشيف الوثائق',   'en'    =>  '’Manage Document Archives'], 'route' => 'document_archives', 'module' => 'document_archives', 'as' => 'document_archives.index', 'icon' => 'fas fa-folder-minus', 'parent' => '0', 'parent_original' => '0', 'sidebar_link' => '1', 'appear' => '1', 'ordering' => '25',]);
        ...
        //Countries
        $manageCountries = Permission::create(['name' => 'manage_countries', 'display_name' => ['ar'  =>  'إدارة البلدان',   'en'    =>  'Manage Countries'], 'route' => 'countries', 'module' => 'countries', 'as' => 'countries.index', 'icon' => 'fas fa-globe', 'parent' => '0', 'parent_original' => '0', 'sidebar_link' => '1', 'appear' => '1', 'ordering' => '40',]);
