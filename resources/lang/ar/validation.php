...
return [
    'custom' => [
        'pages.*.doc_page_name.required'                     => 'اسم الصفحة مطلوب.',
        'pages.*.doc_page_description.required'              => 'وصف الصفحة مطلوب.',
        'pages.*.groups.*.pg_name.required'                  => 'اسم المجموعة مطلوب.',
        'pages.*.groups.*.variables.*.pv_name.required'      => 'اسم المتغير مطلوب.',
        'pages.*.groups.*.variables.*.pv_question.required'  => 'سؤال المتغير مطلوب.',
        'pages.*.groups.*.variables.*.pv_type.required'      => 'نوع المتغير مطلوب.',
        'pages.*.groups.*.variables.*.pv_type.numeric'       => 'نوع المتغير يجب أن يكون رقماً.',
        'pages.*.groups.*.variables.*.pv_required.required'  => 'حقل المتغير المطلوب مطلوب.',
        'pages.*.groups.*.variables.*.pv_required.boolean'   => 'حقل المتغير المطلوب يجب أن يكون صحيح أو خطأ.',
        'pages.*.groups.*.variables.*.pv_details.required'   => 'تفاصيل المتغير مطلوبة.',
    ],
