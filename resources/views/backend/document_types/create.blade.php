    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">
                    <a href="{{ route('admin.document_types.index') }}">{{ __('panel.manage_document_types') }}</a>

                </h4>
                <span class="text-muted mt-1 tx-13 mr-2 mb-0">
                    /
                    {{ __('panel.add_new_document_type') }}
                </span>
            </div>
        </div>
        <div class="d-flex my-xl-auto right-content">
            ...
            <div class="pr-1 mb-3 mb-xl-0">
                ...
                <a href="{{ route('admin.document_types.create') }}" class="btn btn-warning  btn-icon ml-2">
                            ...
                            <div class="col-sm-12 col-md-6 pt-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="doc_type_name" name="doc_type_name"
                                        value="{{ old('doc_type_name') }}" class="form-control" placeholder="">
                                    @error('doc_type_name')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-sm-12 col-md-6 pt-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="doc_type_note" name="doc_type_note"
                                        value="{{ old('doc_type_note') }}" class="form-control" placeholder="">
                                    @error('doc_type_note')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
