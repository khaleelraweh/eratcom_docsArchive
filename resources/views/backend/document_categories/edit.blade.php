    ...
    <div class="breadcrumb-header justify-content-between">
        ...
        <div class="d-flex my-xl-auto right-content">
            ...
            <div class="pr-1 mb-3 mb-xl-0">
                ...
                <a href="{{ route('admin.document_categories.edit', $documentCategory->id) }}"
        ...
        <div class="col-xl-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.document_categories.update', $documentCategory->id) }}" method="post">
                        @csrf
                        @method('PATCH')
                            ...
                            <div class="col-sm-12 col-md-6 pt-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="doc_cat_name" name="doc_cat_name"
                                        value="{{ old('doc_cat_name', $documentCategory->doc_cat_name) }}"
                            ...
                            <div class="col-sm-12 col-md-6 pt-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="doc_cat_note" name="doc_cat_note"
                                        value="{{ old('doc_cat_note', $documentCategory->doc_cat_note) }}"
                                        class="form-control" placeholder="">
                                    @error('doc_cat_note')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                            ...
                            <div class="col-sm-12 col-md-6  pt-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="published_on" name="published_on"
                                        value="{{ old('published_on', \Carbon\Carbon::parse($documentCategory->published_on)->Format('Y-m-d H:i K')) }}"
